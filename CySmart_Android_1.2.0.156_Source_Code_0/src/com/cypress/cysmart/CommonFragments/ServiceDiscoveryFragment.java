...
public class ServiceDiscoveryFragment extends Fragment {
    ...
    private Handler mServiceDiscoveryHandler = new Handler(Looper.myLooper());
...
//                showNoServiceDiscoveredInfo();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Logger.d("SDF: lifecycle: onCreateView " + this + ", " + getActivity());
    ...
    public void onStart() {
        super.onStart();
        Logger.d("SDF: lifecycle: onStart " + this + ", " + getActivity());
    }

    @Override
    public void onResume() {
        super.onResume();
        Logger.d("SDF: lifecycle: onResume " + this + ", " + getActivity());
    ...
    @Override
    public void onPause() {
        Logger.d("SDF: lifecycle: onPause " + this + ", " + getActivity());
        mIsInFragment = false;
    ...
    @Override
    public void onStop() {
        Logger.d("SDF: lifecycle: onStop " + this + ", " + getActivity());
        super.onStop();
    }

    @Override
    public void onDestroy() {
        Logger.d("SDF: lifecycle: onDestroy " + this + ", " + getActivity());
